...
To get omniORB running, you should first install omniORB by following
the instructions in the installation notes for your platform.
...
\noindent As above, but also generate Python stubs for the file
