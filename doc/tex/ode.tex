...
{\Large Summary of Differences from the ODE Versions 2 and 3}
...
At the time of writing, the use of CORBA on NT has not really been tested
fully.  Beano's scoping stuff is still needed, I believe (see section 4.2 of
\cite{ward95}).  None of his Windows GUI stuff has yet been implemented in the
new ODE (see section 5 of \cite{ward95}).
...
``diner'' program from the {\tt /project/omni/version4.0} tree, simply write a
...
ReleasePath /project/omni/version4.0/bin/arm_atmos_3.0/atb
Path /project/omni/version4.0/bin/arm_atmos_3.0/atb
...
The first import tree will be /home/tjr/wob (the export tree)
The final import tree will be /project/omni/version4.0 (the base OMNI tree)
Enter any other import trees in search order
> 
...
Creating OMNI build tree "atmos_hello" for platform "arm_atmos_3.0/atb"

Export tree is /home/tjr/wob
...
/project/omni/version4.0/mk/afterdir.mk:105: hello.d: No such file or directory
/bin/sh -ec "arm-gcc -nostdinc -fno-common -fno-builtin -M  -I.  -I/home/tjr/wo
    .
    .
    .
...
In particular it should not have any {\tt Make} or {\tt Message} directives.
See section \ref{atmosmessages} for information on defining ATMos messages.
...
make -r -f config/config.mk VPATH= TOP=. CURRENT=. OMAKE_TARGET='export' 'export'

+ mkdirhier /home/tjr/wob/bin/arm_atmos_3.0/atb/hello 
+ installbsd -c -m 0644 hello.module /home/tjr/wob/bin/arm_atmos_3.0/atb/hello 
+ installbsd -c -m 0644 hello_exe.o /home/tjr/wob/bin/arm_atmos_3.0/atb/hello 
\end{verbatim}}
...
+ mkdirhier /home/tjr/wob/bin/arm_atmos_3.0/atb/software 
+ installbsd -c -m 0644 hello.pkg /home/tjr/wob/bin/arm_atmos_3.0/atb/software 
\end{verbatim}}

Finally the {\tt hello.pkg} in \verb|/home/tjr/wob/bin/arm_atmos_3.0/atb| can
...
ReleasePath /home/tjr/wob/bin/arm_atmos_3.0/atb
Path /home/tjr/wob/bin/arm_atmos_3.0/atb
