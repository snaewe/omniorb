#
# x86_uw7.mk - make variables and rules specific to SCO OpenServer 5
#
...
#
#   19990729 Allan Clark <allanc@sco.com>
#     port of 2.7.1 to UnixWare/7.1.0 based on OSR504 port
...
IMPORT_CPPFLAGS += -D__x86__ -D__uw7__ -D__OSVERSION__=5
...
Posix_OMNITHREAD_LIB = $(patsubst %,$(LibSearchPattern),omnithread) -Kthread \
		 $(CXXMTFLAG)
Posix_OMNITHREAD_CPPFLAGS = -DUsePthread $(CXXMTFLAG)
OMNITHREAD_POSIX_CPPFLAGS = -DPthreadDraftVersion=11 -DNoNanoSleep
