#
# ia64_hpux_11.23.mk - make variables and rules specific to HPUX 11.23 on Itanium 64bit.
#
...
IMPORT_CPPFLAGS += -D__ia64__ -D__hpux__ -D__OSVERSION__=11
...
#############################################################################
# Tested on:
#     aCC: HP aC++/ANSI C B3910B A.05.57 [June 23 2004] 
#

CPPFLAGS      += +DD64 -fpwidetypes
CXX = aCC
