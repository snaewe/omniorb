...
class PushConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, PushConsumer) {
public:
...
class PullConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, PullConsumer) {
public:
  PullConsumer_i() {;}
...
class PullSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, PullSupplier) {
public:
...
class PushSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, PushSupplier) {
public:
  PushSupplier_i() {;}
...
class StructuredPushConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, StructuredPushConsumer) {
public:
  StructuredPushConsumer_i() : num_push(0) {;}

  inline void push_structured_event(const CosN_StructuredEvent& event    WRAPPED_DECLARG );
...
inline void StructuredPushConsumer_i::offer_change(const CosN_EventTypeSeq& added,
					    	   const CosN_EventTypeSeq& deled   WRAPPED_IMPLARG )
{
  CORBA::ULong indx;
  CosN_EventType   type;
...
class StructuredPullConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, StructuredPullConsumer) {
public:
...
inline void StructuredPullConsumer_i::offer_change(const CosN_EventTypeSeq& added,
						   const CosN_EventTypeSeq& deled    WRAPPED_IMPLARG )
{
  CORBA::ULong indx;
  CosN_EventType   type;
...
class StructuredPullSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, StructuredPullSupplier) {
public:
  inline StructuredPullSupplier_i();

  inline CosN_StructuredEvent* pull_structured_event(  WRAPPED_DECLARG_VOID );
  inline CosN_StructuredEvent* try_pull_structured_event(CORBA::Boolean& has_event    WRAPPED_DECLARG );
...
inline CosN_StructuredEvent* StructuredPullSupplier_i::pull_structured_event( WRAPPED_IMPLARG_VOID )
{
...
inline CosN_StructuredEvent* StructuredPullSupplier_i::try_pull_structured_event(
...
class StructuredPushSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, StructuredPushSupplier) {
public:
...
class SequencePushConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, SequencePushConsumer) {
public:
  SequencePushConsumer_i() : num_batches(0), num_events(0) {;}

  inline void push_structured_events(const CosN_EventBatch& events    WRAPPED_DECLARG );
...
inline void SequencePushConsumer_i::offer_change(const CosN_EventTypeSeq& added,
					  	 const CosN_EventTypeSeq& deled   WRAPPED_IMPLARG )
{
  CORBA::ULong indx;
  CosN_EventType   type;
...
class SequencePullConsumer_i : WRAPPED_SKELETON_SUPER(CosNC::, SequencePullConsumer) {
public:
...
class SequencePullSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, SequencePullSupplier) {
public:
  inline SequencePullSupplier_i();

  inline CosN_EventBatch* pull_structured_events(CORBA::ULong max_number     WRAPPED_DECLARG );
...
class SequencePushSupplier_i : WRAPPED_SKELETON_SUPER(CosNC::, SequencePushSupplier) {
public:
