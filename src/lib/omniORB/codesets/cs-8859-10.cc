...
//
//  /mnt/cdrom/mappings/iso8859/8859-10.txt
//
...
static const _CORBA_Char* frUCS[] = {
  frUCS00, frUCS01, E_T, E_T, E_T, E_T, E_T, E_T,
...
static omniCodeSet::NCS_C_8bit _NCS_C_8859_10(omniCodeSet::ID_8859_10,
                                              "ISO-8859-10",
                                              toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_8859_10(omniCodeSet::ID_8859_10,
                                              "ISO-8859-10",
                                              omniCodeSetUtil::GIOP12,
                                              toUCS, frUCS);

class CS_8859_10_init {
public:
  CS_8859_10_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_8859_10);
    omniCodeSet::registerTCS_C(&_TCS_C_8859_10);
  }
};
static CS_8859_10_init _CS_8859_10_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_8859_10);
