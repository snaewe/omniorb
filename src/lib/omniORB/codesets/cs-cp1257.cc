...
static omniCodeSet::NCS_C_8bit _NCS_C_CP1257(omniCodeSet::ID_CP1257,
                                             "windows-1257",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_CP1257(omniCodeSet::ID_CP1257,
                                             "windows-1257",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_CP1257_init {
public:
  CS_CP1257_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_CP1257);
    omniCodeSet::registerTCS_C(&_TCS_C_CP1257);
  }
};
static CS_CP1257_init _CS_CP1257_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_CP1257);
