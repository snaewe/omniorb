...
//
//  /mnt/cdrom/mappings/iso8859/8859-7.txt
//
...
static const _CORBA_Char* frUCS[] = {
  frUCS00, E_T, E_T, frUCS03, E_T, E_T, E_T, E_T,
...
static omniCodeSet::NCS_C_8bit _NCS_C_8859_7(omniCodeSet::ID_8859_7,
                                             "ISO-8859-7",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_8859_7(omniCodeSet::ID_8859_7,
                                             "ISO-8859-7",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_8859_7_init {
public:
  CS_8859_7_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_8859_7);
    omniCodeSet::registerTCS_C(&_TCS_C_8859_7);
  }
};
