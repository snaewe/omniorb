...
//
//  /mnt/cdrom/mappings/iso8859/8859-2.txt
//
...
static omniCodeSet::NCS_C_8bit _NCS_C_8859_2(omniCodeSet::ID_8859_2,
                                             "ISO-8859-2",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_8859_2(omniCodeSet::ID_8859_2,
                                             "ISO-8859-2",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_8859_2_init {
public:
  CS_8859_2_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_8859_2);
    omniCodeSet::registerTCS_C(&_TCS_C_8859_2);
  }
};
static CS_8859_2_init _CS_8859_2_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_8859_2);
