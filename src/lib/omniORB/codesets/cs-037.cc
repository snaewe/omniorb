// -*- Mode: C++; -*-
//                            Package   : omniORB
// cs-037.cc                  Created on: 29/01/2003
...
// entries 0x20.. 0x40 are unlisted in rfc1345. and are guessed 
// based on whats left over.
...
static omniCodeSet::NCS_C_8bit _NCS_C_037(omniCodeSet::ID_037,
					  "IBM-037",
					  toUCS, fromUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_037_11(omniCodeSet::ID_037,
					     "IBM-037",
					     omniCodeSetUtil::GIOP11,
					     toUCS, fromUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_037_12(omniCodeSet::ID_037,
					     "IBM-037",
...
public:
  CS_037_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_037);
    omniCodeSet::registerTCS_C(&_TCS_C_037_11);
    omniCodeSet::registerTCS_C(&_TCS_C_037_12);
  }
};
static CS_037_init _CS_037_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_037);
