...
static const _CORBA_Char* frUCS[] = {
  frUCS00, frUCS01, frUCS02, E_T, E_T, frUCS05, E_T, E_T,
...
static omniCodeSet::NCS_C_8bit _NCS_C_CP1255(omniCodeSet::ID_CP1255,
                                             "windows-1255",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_CP1255(omniCodeSet::ID_CP1255,
                                             "windows-1255",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_CP1255_init {
public:
  CS_CP1255_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_CP1255);
    omniCodeSet::registerTCS_C(&_TCS_C_CP1255);
  }
};
static CS_CP1255_init _CS_CP1255_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_CP1255);
