...
//
//  /mnt/cdrom/mappings/iso8859/8859-3.txt
//
...
static omniCodeSet::NCS_C_8bit _NCS_C_8859_3(omniCodeSet::ID_8859_3,
                                             "ISO-8859-3",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_8859_3(omniCodeSet::ID_8859_3,
                                             "ISO-8859-3",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_8859_3_init {
public:
  CS_8859_3_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_8859_3);
    omniCodeSet::registerTCS_C(&_TCS_C_8859_3);
  }
};
...
OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_8859_3);
