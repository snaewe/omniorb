...
static omniCodeSet::NCS_C_8bit _NCS_C_CP1252(omniCodeSet::ID_CP1252,
                                             "windows-1252",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_CP1252(omniCodeSet::ID_CP1252,
                                             "windows-1252",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_CP1252_init {
public:
  CS_CP1252_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_CP1252);
    omniCodeSet::registerTCS_C(&_TCS_C_CP1252);
  }
};
static CS_CP1252_init _CS_CP1252_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_CP1252);
