...
//
//  /mnt/cdrom/mappings/iso8859/8859-4.txt
//
...
static omniCodeSet::NCS_C_8bit _NCS_C_8859_4(omniCodeSet::ID_8859_4,
                                             "ISO-8859-4",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_8859_4(omniCodeSet::ID_8859_4,
                                             "ISO-8859-4",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_8859_4_init {
public:
  CS_8859_4_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_8859_4);
    omniCodeSet::registerTCS_C(&_TCS_C_8859_4);
  }
};
static CS_8859_4_init _CS_8859_4_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_8859_4);
