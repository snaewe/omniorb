...
/*
  $Log$
  Revision 1.1.4.3  2000/11/15 17:23:26  sll
...
private:
  ...
  public:
    marshalRequestHeader(omniIOR* ior,
      ...
      pd_ior(ior), pd_op(op), pd_opsize(opsz), pd_response_expected(w),
...
//////////////////////////////////////////////////////////////////
void giop_1_1_Impl::marshalRequestHeader::marshal(cdrStream& s)
{
    // Service context
...
//////////////////////////////////////////////////////////////////
void giop_1_1_Impl::marshalLocateRequestHeader::marshal(cdrStream& s)
{
  pd_request_id >>= s;
...
//////////////////////////////////////////////////////////////////
void giop_1_1_Impl::marshalReplyHeader::marshal(cdrStream& s)
{
  // Service context
  operator>>= ((CORBA::ULong)0,s);
...
//////////////////////////////////////////////////////////////////
void giop_1_1_Impl::marshalLocateReplyHeader::marshal(cdrStream& s)
{
  pd_r.requestID() >>= s;
