...
/*
  $Log$
  Revision 1.1.2.1  2001/02/23 16:46:57  sll
  Added new files.
...
CORBA::Long giopStrand::idleIncomingBeats = 36;
CORBA::Long giopStrand::idleOutgoingBeats = 24;
CORBA::Long giopStrand::scanPeriod        = 5;
