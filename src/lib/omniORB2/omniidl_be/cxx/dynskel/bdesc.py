...
# $Id$
# $Log$
# Revision 1.12.2.4  2000/03/16 16:19:39  djs
# Missed an extern function declaration when it didn't dereference a typedef
# chain which lead to a structure defined outside the current file.
#
