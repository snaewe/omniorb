...
/*
  $Log$
  Revision 1.1.2.4  2001/07/24 14:58:53  dpg1
...
public:
  ...
  inline omniObjAdapter*    adapter() const  { return pd_adapter;       }
  ...
  inline void setServant(omniServant* servant, omniObjAdapter* oa) {
...
private:
  friend class omniLocalIdentity_RefHolder;
