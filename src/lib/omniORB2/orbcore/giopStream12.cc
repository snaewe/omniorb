...
private:
  ...
  inline void* get_outb_mkr(giopStream* g) { return g->pd_outb_mkr; }
  ...
  public:
    marshalRequestHeader(giopStream* s,GIOPObjectInfo* i,
      ...
      end_of_data(0),
      pd_s(s), pd_i(i), pd_op(op), pd_opsize(opsz), pd_oneway(w),
  ...
  public:
    marshalReplyHeader(giopStream* s,giopStream::requestInfo& r,
      ...
      end_of_data(0), pd_s(s), pd_r(r), pd_t(t) {}
...
public:
					...
					CORBA::Boolean response_expected)
  {
    ...
    marshalRequestHeader marshaller(g,f,opname,opnamesize,oneway,
				    response_expected,
				    g->pd_request_id);
...
public:
  ...
  again:
	...
	b = g->pd_strand->receive(reqsize,1,
      ...
      // XXX
      assert(g->pd_input_msgfrag_to_come >= b.size);
...
//////////////////////////////////////////////////////////////////
void giop_1_2_Impl::marshalRequestHeader::marshalData()
{
  cdrStream& s = *pd_s;
  ...
  end_of_data = giop_1_2_singleton->get_outb_mkr(pd_s);

  s.alignOutput(omni::ALIGN_8);
}

//////////////////////////////////////////////////////////////////
size_t giop_1_2_Impl::marshalRequestHeader::dataSize(size_t initialoffset)
{
...
//////////////////////////////////////////////////////////////////
void giop_1_2_Impl::marshalLocateRequestHeader::marshalData()
{
  cdrStream& s = *pd_s;
...
//////////////////////////////////////////////////////////////////
size_t giop_1_2_Impl::marshalLocateRequestHeader::dataSize(size_t initialoffset)
{
  cdrCountingStream s(initialoffset);
...
//////////////////////////////////////////////////////////////////
void giop_1_2_Impl::marshalReplyHeader::marshalData()
{
  cdrStream& s = *pd_s;
...
//////////////////////////////////////////////////////////////////
size_t giop_1_2_Impl::marshalReplyHeader::dataSize(size_t initialoffset)
{
  cdrCountingStream s(initialoffset);
...
//////////////////////////////////////////////////////////////////
void giop_1_2_Impl::marshalLocateReplyHeader::marshalData()
{
  cdrStream& s = *pd_s;
...
//////////////////////////////////////////////////////////////////
size_t giop_1_2_Impl::marshalLocateReplyHeader::dataSize(size_t initialoffset)
{
  cdrCountingStream s(initialoffset);
  pd_r.requestID() >>= s;
  CORBA::ULong rc = (CORBA::ULong) pd_t;
...
public:
  ...
  void fetchFragment(giopStream* g) {
    ...
    assert(hdr[0] == 'G' && hdr[1] == 'I' && hdr[2] == 'O' &&
	   hdr[3] == 'P' && hdr[4] == 1   && hdr[5] == 2);
    assert(hdr[7] <= (unsigned char) GIOP::Fragment);
    assert(g->pd_unmarshal_byte_swap == bswap);
#endif
...
public:
...
#ifdef PARANOID
      assert(s.pd_input_fragmented == 0);
      assert(s.pd_input_hdr_end != 0);
#endif
  ...
  void convertToBufferedInput(giopStream* g)
  {
    ...
    assert(((omni::ptr_arith_t)g->pd_inb_end & 0x7)==0);
