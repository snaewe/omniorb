// -*- Mode: C++; -*-
//                            Package   : omniORB2
// TCPSocket_ATMOS.h          Created on: 4/11/96
...
/*
  $Log$
  Revision 1.4  1997/05/06 15:29:22  sll
  Public release.
...
#ifndef __TCPSOCKET_ATMOS_H__
#define __TCPSOCKET_ATMOS_H__
...
public:
  ...
  tcpSocketRendezvous(tcpSocketRope *r,tcpSocketHandle_t connfilep);
