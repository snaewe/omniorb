...
#
# omniDynamic305_rt.lib is the runtime DLL to support the CORBA dynamic
...
# to functions in omniDynamic305_rt.lib when compiling the stubs.
...
# lines.
#OMNI_DYNAMIC_LIB = omniDynamic305_rt.lib
...
CORBA_LIB      = omniORB305_rt.lib omnithread2_rt.lib \
                 $(OMNI_DYNAMIC_LIB) \
...
#
#OMNI_DYNAMIC_LIB = omniDynamic305_rtd.lib
#OMNI_DYNAMIC_LIB = msvcstubd.lib -NODEFAULTLIB:libcmt.lib -NODEFAULTLIB:libcmtd.lib 
#CORBA_CPPFLAGS = -D__WIN32__ -D__x86__ -D__NT__ -D__OSVERSION__=4
#CORBA_LIB      = omniORB305_rtd.lib omnithread2_rtd.lib \
#                 $(OMNI_DYNAMIC_LIB) \
