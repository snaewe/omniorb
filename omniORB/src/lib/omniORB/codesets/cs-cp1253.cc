...
static const _CORBA_Char* frUCS[] = {
  frUCS00, frUCS01, E_T, frUCS03, E_T, E_T, E_T, E_T,
...
static omniCodeSet::NCS_C_8bit _NCS_C_CP1253(omniCodeSet::ID_CP1253,
                                             "windows-1253",
                                             toUCS, frUCS);

static omniCodeSet::TCS_C_8bit _TCS_C_CP1253(omniCodeSet::ID_CP1253,
                                             "windows-1253",
                                             omniCodeSetUtil::GIOP12,
                                             toUCS, frUCS);

class CS_CP1253_init {
public:
  CS_CP1253_init() {
    omniCodeSet::registerNCS_C(&_NCS_C_CP1253);
    omniCodeSet::registerTCS_C(&_TCS_C_CP1253);
  }
};
static CS_CP1253_init _CS_CP1253_init_;

OMNI_NAMESPACE_END(omni)

OMNI_EXPORT_LINK_FORCE_SYMBOL(CS_CP1253);
