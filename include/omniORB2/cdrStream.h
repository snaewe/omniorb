...
/*
  $Log$
  Revision 1.1.2.1  1999/09/15 20:54:01  sll
  *** empty log message ***

  Revision 1.2  1999/09/12 20:33:39  sll
  Unmarshal array functions should be public.

  Revision 1.1  1999/09/12 19:36:48  sll
  Initial revision
...
#error "CdrUnMarshal has already been defined"
  ...
  virtual omniObject* unMarshalObjRef(const char* repoId);
  virtual void marshalObjRef(omniObject* obj);
