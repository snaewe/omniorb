...
<table border="0" width="100%" cellspacing="0" cellpadding="8">
  ...
  <tr>
    <td width="100%" bgcolor="#FFFFFF" colspan="3">
	  ...
	  select="@version"/> have been fixed. </p>

          <p> Please note that newer omniORB releases may have bug fixes
              that have not been back ported to this release. If you
              think you have encountered a bug that is not listed below,
              it is best to upgrade to the latest omniORB release if you can.
          </p>
          ...
          <ul><li>Update from <a href="cvs.html">CVS</a> in the
                  <code>"omni2_8_develop"</code> branch.</li>

              <li>Download the latest <a
              href="ftp://ftp.uk.research.att.com/pub/omniORB/omniORB_28_snapshots/">source
